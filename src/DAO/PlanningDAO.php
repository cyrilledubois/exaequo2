...
class PlanningDAO extends DAO{
	...
	public function getInfoPlanning($date_jour){
        ...
        $result = $this->bdd->prepare('SELECT planning.id, date_cours, duree, nom, intensite FROM planning INNER JOIN cours ON planning.id_cours = cours.id WHERE date_cours LIKE :date_jour');
